  ...
  return (
    <Card className="p-4 bg-slate-100 dark:bg-slate-900 bg-opacity-60 text-left">
      ...
      <p className="pt-2">
        ...
        중 트릭컬 노트는 사용자의 개인정보를 조회할 수 없습니다.
      </p>
      <p className="pt-4">2) 사용자 데이터 분석</p>
      <p className="pt-2">
      ...
      <p className="pt-4">
        트릭컬 노트는 사용자의 개인정보를 자체적으로 저장하지 않습니다. 사용자의
        서비스 데이터는 Google Drive에 저장되며, 사용자가 트릭컬 노트 서비스
        데이터를 파기하려면 Google Drive 설정의 앱 관리 메뉴에서 트릭컬 노트
        항목의 옵션을 눌러서 데이터를 삭제하면 됩니다.
      </p>
      ...
      <p className="pt-2">
        ...
        드라이브를 통해 트릭컬 노트 서비스 데이터를 동기화할 때만 사용됩니다.
      </p>
